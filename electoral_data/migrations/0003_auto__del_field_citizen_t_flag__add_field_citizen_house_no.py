...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Citizen.t_flag'
        db.delete_column(u'electoral_data_citizen', 't_flag')

        # Adding field 'Citizen.house_no'
        db.add_column(u'electoral_data_citizen', 'house_no',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Citizen.t_flag'
        db.add_column(u'electoral_data_citizen', 't_flag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'Citizen.house_no'
        db.delete_column(u'electoral_data_citizen', 'house_no')
    ...
    models = {
        ...
        u'electoral_data.citizen': {
            ...
            'house_no': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
