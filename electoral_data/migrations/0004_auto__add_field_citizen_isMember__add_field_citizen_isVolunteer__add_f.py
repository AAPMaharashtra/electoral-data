...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Citizen.isMember'
        db.add_column(u'electoral_data_citizen', 'isMember',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Citizen.isVolunteer'
        db.add_column(u'electoral_data_citizen', 'isVolunteer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Citizen.isDonor'
        db.add_column(u'electoral_data_citizen', 'isDonor',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Citizen.isMember'
        db.delete_column(u'electoral_data_citizen', 'isMember')

        # Deleting field 'Citizen.isVolunteer'
        db.delete_column(u'electoral_data_citizen', 'isVolunteer')

        # Deleting field 'Citizen.isDonor'
        db.delete_column(u'electoral_data_citizen', 'isDonor')
